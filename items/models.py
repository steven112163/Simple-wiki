...
class Item(models.Model):
    ...
    material = models.ForeignKey(Material, verbose_name=u'材料', on_delete=models.SET_NULL, blank=True, null=True)
    type = models.ForeignKey(Type, verbose_name=u'類型', on_delete=models.SET_NULL, blank=True, null=True)
